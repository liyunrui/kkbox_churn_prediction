...
In case of time- eries, including more recent data is always better.
...
'''
有明顯的overfitting on validating set, 因為我是使用hold-out method, 隨機挑1/5的人來做validation,
這1/5的人的分佈未必 和testing set中的人分佈是相同的。

Keep in mind training set, validating set, and testing set都只是母體的一部分sample。
