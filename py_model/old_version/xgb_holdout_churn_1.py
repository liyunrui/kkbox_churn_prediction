...
# XGB param
nround = 10000 # larger learning rate, smaller nround
#nround = 10
...
sub_test = test[['msno']] # for output

dtest  = xgb.DMatrix(test[col_train]) # only using the feature is trained by xgb
sub_test['is_churn'] = 0
for model in models:
